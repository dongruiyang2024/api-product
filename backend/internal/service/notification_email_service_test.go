...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "oneAPI", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "oneAPI", "https://example.com/reset", "en-US"))
