<template>
    ...
    <p
      v-if="showRegistrationLink && !backendModeEnabled && publicSettingsLoaded && registrationEnabled"
...
const redirectTarget = computed(
  () => props.redirectTo || (router.currentRoute.value.query.redirect as string) || '/dashboard'
)
