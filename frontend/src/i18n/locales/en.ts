export default {
  ...
  home: {
    ...
    tags: {
      subscriptionToApi: 'AI Model Service',
  ...
  setup: {
    title: 'Site Setup',
    description: 'Configure your AI model service platform',
    database: {
  ...
  admin: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for site user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for site user login',
      ...
      site: {
        ...
        siteSubtitlePlaceholder: 'Unified AI Model Service Platform',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to this platform',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the AI model service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #0284c7; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
