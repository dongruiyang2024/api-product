<template>
  <div
    class="flex min-h-screen items-center justify-center bg-[#f8fbff] p-4 text-slate-950 dark:bg-dark-950 dark:text-gray-100"
  >
    <div class="w-full max-w-2xl">
      <!-- Logo & Title -->
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-primary-600 shadow-lg shadow-primary-500/25"
        >
      ...
      <!-- Step Content -->
      <div class="rounded-lg border border-sky-100 bg-white p-8 shadow-xl shadow-sky-100/60 dark:border-dark-700 dark:bg-dark-800 dark:shadow-none">
        <!-- Step 1: Database -->
