...
describe('feature route guard', () => {
  ...
  it('restores authentication before the first public home navigation and only once', async () => {
    authStore.isAuthenticated = false
    authStore.checkAuth.mockImplementationOnce(() => {
      authStore.isAuthenticated = true
      authStore.isAdmin = true
    })
    appStore.publicSettingsLoaded = true

    const first = runGuard({ requiresAuth: false }, '/home')
    ...
    const second = runGuard({ requiresAuth: false }, '/home')
